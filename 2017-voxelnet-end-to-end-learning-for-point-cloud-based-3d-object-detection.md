...
| 코드 | `docker push adioshun/voxelnet`,[VoxelNet-ROS](https://github.com/tigerk0430/voxelnet_ros), [TF](https://github.com/qianguih/voxelnet) / [Docker](https://github.com/aaalgo/awesome-dl-docker/blob/master/voxelnet/Dockerfile), [pytorch](https://github.com/skyhehe123/VoxelNet-pytorch), [TF](https://github.com/jeasinema/VoxelNet-tensorflow),~~[Docker(비번필요)](https://hub.docker.com/r/pyun/voxelnet)-[README](https://github.com/pyun-ram/FL3D/tree/master/VoxelNet)~~,[Chainer](https://github.com/yukitsuji/voxelnet_chainer) |
...
# [qianguih/voxelnet](https://github.com/qianguih/voxelnet) 코드 기반 
